...
# convention; if it differs the source is in ACCEPT_BROKEN and the next
# run's diagnostics will say so — override via SUBTERRA_PROCESSING_PLANTS_URL.
DEFAULT_QUERY_URL = (
...
def run(work_dir: Path) -> SourceResult:
    ...
    url = os.environ.get("SUBTERRA_PROCESSING_PLANTS_URL", "").strip() or DEFAULT_QUERY_URL
