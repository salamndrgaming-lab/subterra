  ...
  return (
    <div className="flex h-full flex-col items-center justify-center bg-bg text-center">
      ...
      <div className="mt-6 flex gap-3">
        <Link href="/" className="rounded-md border border-border bg-bg-panel px-4 py-2 font-mono text-xs text-text">
          Home
        </Link>
        <Link href="/map" className="rounded-md bg-accent px-4 py-2 font-mono text-xs text-bg">
          Open the map →
        </Link>
      </div>
    </div>
