-- Subterra Cloudflare D1 schema (SQLite at the edge).
-- Apply with: wrangler d1 migrations apply subterra
-- This is the v0 baseline; future migrations live in infra/migrations/.
...
CREATE TABLE IF NOT EXISTS aois (
  ...
  name          TEXT NOT NULL,
  notes         TEXT,
  geometry_json TEXT NOT NULL,         -- GeoJSON Polygon
